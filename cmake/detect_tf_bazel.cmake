if(EXISTS ${TF_BAZEL_LIBRARY})
  ...
  if(EXISTS ${TF_BAZEL_LIBRARY}.1)
    if(NOT EXISTS ${TENSORFLOW_LIBRARY}.1)
      ...
      if("${LINK_FAILED}" STREQUAL "0")
        message("-- -- Created tensorflow library link ${TF_BAZEL_LIBRARY}.1 -> ${TENSORFLOW_LIBRARY}.1.")
      else()
        message(WARNING "-- -- Could not create symlink from ${TF_BAZEL_LIBRARY}.1 -> ${TENSORFLOW_LIBRARY}.1.")
        return()
      endif()
    endif()
...
if(EXISTS ${TF_BAZEL_SRC_DIR})
  ...
  list(APPEND TENSORFLOW_INCLUDE_DIRS ${BAZEL_TF_DIR}/external/com_google_absl)
